...
const StyleDetailPage: React.FC<StyleDetailPageProps> = ({ style, initialPlans }) => {
  ...
  return (
    <Container>
      <BreadcrumbNav>
        <Link href="/">Home</Link> &gt; <Link href="/styles">Home Styles</Link> &gt; {style.name}
      </BreadcrumbNav>
      ...
      <Hero>
        <FallbackImage 
          ...
          fallbackSrc={`https://placehold.co/1200x500?text=${encodeURIComponent(style.name)}`}
          priority
        />
        <div className="overlay">
          <h1>{style.name} House Plans</h1>
      ...
      <StyleInfo>
        <div className="style-description">
          <div className="main-content">
            <h2>About {style.name} Style Homes</h2>
            <div dangerouslySetInnerHTML={{ __html: style.fullDescription }} />
          </div>
          
          <div className="side-content">
            <div className="quick-facts">
              <h3>{style.name} Characteristics</h3>
              <ul>
      ...
      <SortAndResultsBar>
        <ResultCount>
          {loading ? 'Loading plans...' : `${filteredPlans.length} ${style.name} plans found`}
        </ResultCount>
